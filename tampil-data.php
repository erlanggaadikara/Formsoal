  <div class="row">
    <div class="col-md-12">
      <div class="page-header">
        ...
        <h4>
          <a class="btn btn-success pull-center" href="index_cerita.php">Soal Cerita -></a>
        </h4>
      </div>
  ...
  // jika alert = 4
  // tampilkan pesan Gagal "no_soal sudah ada"
  elseif ($_GET['alert'] == 4) {
    echo "<div class='alert alert-danger alert-dismissible' role='alert'>
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
              <span aria-hidden='true'>&times;</span>
            </button>
            <strong><i class='glyphicon glyphicon-remove-circle'></i> Gagal!</strong> no_soal $_GET[no_soal] sudah ada.
          </div>";
  }
  // jika alert = 5
  ...
  ?>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Soal-soal Itung-itungan</h3>
        </div>
        <div class="panel-body">
          <table class="table table-striped table-hover" id="dataTables-example">
            ...
            try {
              ...
              $query = "SELECT * FROM Soal ORDER BY no_soal DESC";
              ...
              while ($data = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo "  <td width='60'>$data[no_soal]</td>
                        <td width='60'>$data[tipe]</td>
                        <td width='60'>$data[lvl]</td>
                        <td width='60'>$data[soal]</td>
                        <td width='60'>$data[jawaban]</td>
                        <td width='60'>$data[Pilihan_a]</td>
                        <td width='60'>$data[Pilihan_b]</td>
                        <td width='60'>$data[Pilihan_c]</td>
                        <td width='60'>$data[Pilihan_d]</td>

                        <td width='100'>
                          <div class=''>
                            <a href='#' data-toggle='tooltip' data-placement='top' title='Ubah' style='margin-right:5px' class='btn btn-success btn-sm open_modal' id='$data[no_soal]' >
                              <i class='glyphicon glyphicon-edit'></i>
                            </a>";
                ?>
                            <a href="#" onclick="confirm_modal('proses-hapus.php?&no_soal=<?php echo $data['no_soal']; ?>');" data-no_soal="<?php echo $data['no_soal']; ?>" data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm">
        ...
        <div class="modal-body">
          <form action="proses-simpan.php" method="POST" name="modal_popup" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="No_soal" autocomplete="off" required/>
            </div>

            <div class="form-group">
              <label>Tipe Soal</label>
              <select class="form-control" name="tipe" placeholder="Pilih Tipe" required>
            ...
            <div class="form-group">
              <label>Level</label>
              <select class="form-control" name="lvl" placeholder="Pilih Level" required>
            ...
            <div class="form-group">
              <label>Soal</label>
              <input type="text" class="form-control" name="Soal" autocomplete="off" required/>
            </div>
          ...
          <div class="form-group">
             ...
             <input type="text" class="form-control" name="Pilihan_a" autocomplete="off" required/>
         </div>

         <div class="form-group">
            <label>Pilihan B</label>
            <input type="text" class="form-control" name="Pilihan_b" autocomplete="off" required/>
        </div>

        <div class="form-group">
           <label>Pilihan C</label>
           <input type="text" class="form-control" name="Pilihan_c" autocomplete="off" required/>
       </div>

       <div class="form-group">
          <label>Pilihan D</label>
          <input type="text" class="form-control" name="Pilihan_d" autocomplete="off" required/>
      </div>
